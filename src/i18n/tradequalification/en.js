export default {
    tradequTitle: 'GoodToken: Futures Trading',
    // 第一步
    ...
    content2: 'The natural advantages of GoodToken futures contracts are:',
    ...
    content11: 'For example, assuming 0 transaction costs, a client uses 1 BTC as margin (opening margin) to buy/long some BTC contracts with a total value of 10 BTC (opening value) at the price of 6000 USD:When the price of the contract increases by 5% to 6300 USD, the current value of the long position becomes 10.5 BTC. The unrealized profit and loss is 0.5 BTC. The rate of return is 50% (Unrealized profit & loss of this position/ Opening margin).',
    ...
    content13: 'For example, assuming 0 transaction costs, a client uses 1 BTC as margin (opening margin) to sell/short some BTC contracts with a total value of 10 BTC (opening value) at the price of 6000 USD:When the price of the contract drops by 5% to 5700 USD, the current value of the long position becomes 9.5 BTC. The unrealized profit & loss is 0.5 BTC. The rate of return is 50% (Unrealized profit & loss of this position /Opening margin).',
    label3: '4.When can you withdraw your profits?',
    content14: 'Clients can withdraw profits (be it realized or unrealized) immediately on GoodToken, as long as remaining margin account balance >= margin requirement.Unrealized or realized profits can also be used immediately to place new orders.Also clients are not responsible for any “socialized loss” resulting from negative margin.Moreover GoodToken does NOT keep any remaining balance of a forced liquidation. When a client is liquidated due to loss, he/she will retain all remaining balances in his/her margin account.',
    label4: '5. How are contracts priced and settled?',
    content15: 'All futures contracts at GoodToken are settled in BTC and quoted in USD. For example, contract ETH1912 is quoted in USD and settled in BTC.',
    content16: 'Futures contracts on GoodToken are classic expiring contracts, as opposed to "perpetual contracts". The settlement time is detailed in Contract Information on the Futures page.',
    ...
    answer3: '10 BTC',
    answer4: '2 BTC',
    question3: '3.An investor enters into a long position of BTC futures contract at 6,000 USD with 10x leverage. The total margin requirement of this position is 1 BTC. Should the price of that contract go up 10% to 6,600, what would be the profit of the investor?',
    answer5: '0.1 BTC',
    answer6: '1 BTC',
    question4: '4.An investor enters into a short position of BTC futures contract at 6,000 USD with 10x leverage. The total margin requirement of this position is 1 BTC. Under which of the following circumstances would the investor suffer a 50% loss of 0.5 BTC?',
    answer7: '0.1 BTC',
    answer8: '1 BTC',
    question5: "5.An investor has a short position in BTC1912 contract on FOTA platform with 1 BTC of unrealized profit. He expects BTC to keep dropping and would not like to close his position. In this case, could the 1 BTC of unrealized profits be withdrawn from the investor's FOTA margin account?",
    answer9: 'No, one cannot withdraw unrealized profits',
    answer10: "Yes, FOTA's STAMP margin system allows clients to withdraw both realized and unrealized profits immediately",
    ...
    agreement: ' Term of Use for FOTA Virtual Contract Users',
    ...
    // 方塔虚拟用户协议
    xieyi: 'FOTA User Agreement',
    xieyiTime: 'Updated and effective as of September 16, 2018',
    xieyiLabel1: '1.Overview',
    xieyiContent1: '1.1 Futures trading is a digital asset derivative launched by FOTA. It is also a trading platform designed, managed, and operated by FOTA.',
    xieyiLabel2: '2.Futures Trading Rules',
    xieyiContent2_1: '2.1 The tokens available in futures trading include BTC, ETH, EOS, BCH, ETC, LTC and other digital assets approved by FOTA. All contracts are priced and settled in USDT.',
    ...
    xieyiContent2_3: '2.3 The contract expiration date is 4 PM(UTC+8), the 28th day of the third month after it is live. For example, the expiration date for the FOTA 0628, FOTA 0728, FOTA 0828 are September 28th, October 28th and November 28th, respectively.',
    ...
    xieyiContent3_1: '3.1 The user may place the order via the webpage, App, API and other means approved  by FOTA. The order  includes price,  volume,  direction and other contents required by FOTA. ',
    ...
    xieyiContent4_1: '4.1 FOTA futures adopts cross-margin mode.',
    xieyiContent4_2: 'FOTA futures contract adopts cross-margin mode, in which the total equity balance, plus all the profits and losses will be used as margin. User\'s Margin Rate=Total Account Assets/Position Value. When the margin ratio goes down, the account will be possibly liquidated. ',
    ...
    xieyiContent4_5: '4.4 If the size of a user\'s position or open orders accumulate to a level which poses a clawback threat to the futures trading system or other users, FOTA may request to cancel your orders or reduce part of your position. As a final measure, FOTA reserves the right to limit or partially cancel the position or orders to reduce the risk in the system.',
    ...
    xieyiContent5_2: '5.2 FOTA is entitled to give warning to any unethical behaviors such as malign manipulation of price or affecting transaction system, etc. and to take measures like transaction restraint, closing the accounts and so on. If necessary, FOTA is entitled to suspend the transaction, canceling the transaction, rolling back transaction during certain period of time, etc. in order to eliminate the negative impact.',
    xieyiContent5_3: '5.3 If the size of a user\'s position or open orders accumulate to a level which poses a clawback threat to the futures trading system or other users, FOTA may request to cancel your orders or reduce part of your position. As a final measure, FOTA reserves the right to limit or partially cancel the position or orders to reduce the risk in the system.',
    xieyiContent5_4: '5.4 FOTA shall not be liable for the compensation for damages by users\' inability to use various services or place order due to system failure caused by following situations, including, but not limited to:',
    xieyiContent5_10: 'A. Announced shutdown for maintenance of FOTA platform;',
    ...
    xieyiContent5_5: '5.5 In the event of abnormal trading, interrupted transaction and other abnormal situations caused by system failure, network problems, hacker attack like DDos and so on, FOTA is entitled to revoke the abnormal  transaction and rolling back transactions in a previous time window.',
    xieyiContent5_6: '5.6 Any unjustifiable transaction is prohibited on the FOTA transaction platform, including, but not limited to, user making malice entrustment by utilizing the possible system bug and manipulate  the price and volume by means of overflowing order , using affiliated accounts for reversed transactions, etc.. In this situation, FOTA is entitled to cancel the abnormal  transaction and rolling back transactions in a previous time window.',
    xieyiContent5_7: '5.7 This agreement includes also rules and regulations of FOTA, other agreement, and rules as Appendixes to this agreement and other relevant agreements and rules regarding the services issued by FOTA from time to time and so on. The above-mentioned rules and agreements shall become the integrated part of this agreement after their issuance to be aided by all parties hereto. in the event of conflicts between these agreement band rules and this agreement, the latter shall prevail. Once you registered or use any service hereunder, it shall be deemed that you have read and accepted this agreement as well as subject to the restraint under the above-mentioned documents.  FOTA shall be entitled to unilaterally modified this agreement or above-mentioned documents, if necessary. Upon modification, if you continue to use this service, it shall be deemed that you have accepted the modification and you should stop to use relevant service if you do not accept such modification.',
    ...
    xieyiContent5_9: '5.9 If there are any disputes or controversies between you and FOTA, it shall be at first settled through friendly discussion. If it fails through friendly discussion, it is agreed to submit such dispute or controversy to the court of jurisdiction in Singapore for final settlement.',
