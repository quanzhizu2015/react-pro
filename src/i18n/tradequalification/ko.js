export default {
    ...
    label3: '4.수익 출금.',
    content14: 'FOTA 플랫폼은 전품종 통합 증거금 시스템, STAMP 시스템을 개발하여 마이너스 증거금 발생 가능성을 피면하여 기타 수익자의 수익금으로 공동 부담 할 필요가 없다. 수익자의 수익금을 동결하지 않으므로서 수익자는 수익이 발생한 포지션에서 수익금을 실시간으로 전이 할수 있게 되였다. 출금도 정해진 시간이 따로 없이 실시간으로 출금 할수있게 설계 되었다.',
    label4: '5. 가격산정과 청산.',
    content15: 'FOTA플랫폼의 모든 선물거래의 마진은 BTC이며 선물가격 산정단위는 USD 이다. 예, ETH1912 선물거래의 가격산정 단위는 USD이며 마진 청산 단위는 BTC 이다.',
    content16: '선물계약의 청산 시간은 해당 월28일, 17:00 (한국시간) 이다. 예; BTC1811계약 청산일은 2018년11월28일,17:00 이다. 청산 시점에 플랫폼은 모든 해당 선물거래에 대해 청산을 진행 한다.',
    content17: 'FOTA 플랫폼은 정통선물 거래소 이며 계약코드 중의 숫자는 해당 계약의 청산 년월을 나타 낸다. 예; BTC1912 계약의 청산일은 2019년12월28일 09:00(UTC+0), BTC1911계약의 청산일은 2019년11월28일 09:00(UTC+0).',
    ...
    answer9: 'FOTA 플랫폼은 미청산 포지션의 수익금을 출금 할수 없다.',
    answer10: 'FOTA 플랫폼은 미청산 포지션의 수익금을 실시간으로 출금 할수 있다.',
